// ======================================================================
// Byte-Oscilloscope.v generated from TopDesign.cysch
// 07/15/2023 at 23:06
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=FILTER_OP1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=FILTER_OP1, CY_INSTANCE_SHORT_NAME=FILTER_OP1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=FILTER_OP1, )
module OpAmp_PDL_v1_0_1 (
    Vminus,
    Vout,
    Vplus);
    inout       Vminus;
...
// OpAmp_PDL_v1_0(DeepSleepSupport=false, Mode=0, OpampRange=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_PDL_v1_0, CY_CONFIG_TITLE=FILTER_OP0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=FILTER_OP0, CY_INSTANCE_SHORT_NAME=FILTER_OP0, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ctb, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=FILTER_OP0, )
module OpAmp_PDL_v1_0_2 (
    Vminus,
    Vout,
    Vplus);
    inout       Vminus;
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=100, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=199, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=ADC_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_PWM, CY_INSTANCE_SHORT_NAME=ADC_PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_PWM, )
...
// SCB_UART_PDL_v2_0(BaudRate=1000000, BitsOrder=0, BreakSignalBits=11, BufferMinSize=64, ByteMode=true, ClkFreqDes=10000, ClkMinusTolerance=5, ClkPlusTolerance=5, ClockFromTerm=true, ComMode=0, CtsPolarity=0, CtsTermEnable=false, DataWidth=8, Direction=3, DropOnFrameErr=false, DropOnParityErr=false, EnableCts=false, EnableInputFilter=false, EnableMultiProc=false, EnableRts=false, EnableRxOutput=false, EnableTxEn=false, EnableTxOutput=false, InterruptMode=1, InterruptTermEnable=false, IntrRxBreakDetected=true, IntrRxFrameErr=false, IntrRxFull=false, IntrRxNotEmpty=false, IntrRxOverflow=false, IntrRxParityErr=false, IntrRxTrigger=false, IntrRxUnderflow=false, IntrTxEmpty=false, IntrTxNotFull=false, IntrTxOverflow=false, IntrTxTrigger=false, IntrTxUartDone=false, IntrTxUartLostArb=false, IntrTxUartNack=false, IntrTxUnderflow=false, IrdaLowPower=false, IrdaPolarity=0, IsCtsPinAllowed=true, IsDmaCapable=true, IsEnableInputFilterVisible=true, IsMultiprocessorModeAvailable=false, IsRtsPinAllowed=true, IsRtsTriggerLevelVisible=false, IsRxIntrSourcesVisible=false, IsRxTriggerLevelVisible=false, IsTxIntrSourcesVisible=false, IsTxTriggerLevelVisible=false, MaxFifoLevel=127, MpRxAcceptAddress=false, MpRxAddress=0, MpRxAddressMask=255, OvsFactor=10, ParityType=0, PreconfigureIO=false, RemoveCtsPin=true, RemoveIntr=false, RemoveRtsPin=true, RemoveRxPin=true, RemoveRxTxPin=true, RemoveTxEnPin=true, RemoveTxPin=true, RtsPolarity=0, RtsTermEnable=false, RtsTriggerLevel=63, RxIntrMask=0, RxTermEnable=true, RxTriggerLevel=63, RxTxTermEnable=false, ShowTerminals=true, SmCardRetryOnNack=false, StopBits=2, SymbolShape=2, TriggerOutputEnable=false, TxEnTermEnable=false, TxIntrMask=0, TxTermEnable=true, TxTriggerLevel=63, UartMode=2, UseIntr=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SCB_UART_PDL_v2_0, CY_CONFIG_TITLE=OSCILLOSCOPE_UART, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OSCILLOSCOPE_UART, CY_INSTANCE_SHORT_NAME=OSCILLOSCOPE_UART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=scb, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=OSCILLOSCOPE_UART, )
...
module top ;
    ...
    Scan_ADC_v3_10_0 OSCILLOSCOPE_ADC (
        .aclk(Net_436),
        .eos(Net_317),
        .sdone(Net_437),
        .soc(Net_285),
        ...
        .t_dav(Net_441),
        .t_fvalid(Net_442),
        .t_fvinternal(Net_443[1:0]),
        .t_fvout(Net_444),
        .vagnd(Net_445),
        .vinPlus_0(Net_92));

    OpAmp_PDL_v1_0_1 FILTER_OP1 (
        .Vminus(Net_12),
        .Vout(Net_13),
        .Vplus(Net_14));

    OpAmp_PDL_v1_0_2 FILTER_OP0 (
        .Vminus(Net_15),
        .Vout(Net_16),
        .Vplus(Net_17));
	...
	cy_clock_v1_0
		#(.id("c9ecb9a0-06b1-462b-bc7e-e7227af7208c"),
	...
	cy_clock_v1_0
		#(.id("fc234925-4b74-4947-8173-06e25cb1913f"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(5),
		  .period("0"),
		  .is_direct(0),
    ...
    DMA_PDL_v2_0_4 ADC_DMA (
        .interrupt(Net_31),
        .tr_in(Net_317),
        .tr_out(Net_1628));

    SCB_UART_PDL_v2_0_5 OSCILLOSCOPE_UART (
        .clock(Net_32),
        .cts_in(1'b0),
        .interrupt(Net_34),
        .rts_out(Net_35),
	...
	cy_clock_v1_0
		#(.id("a2c4611a-6781-4fe5-98ba-314a1229fdfe"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(5),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__LED_GPIO_net;
	wire [0:0] tmpIO_0__LED_GPIO_net;
	electrical [0:0] tmpSIOVREF__LED_GPIO_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LED_GPIO
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_GPIO_net[0:0]}),
		  .io({tmpIO_0__LED_GPIO_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_GPIO_net));
