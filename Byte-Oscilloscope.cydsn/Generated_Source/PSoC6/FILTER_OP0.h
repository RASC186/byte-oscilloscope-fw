/*******************************************************************************
* File Name: FILTER_OP0.h
* Version 1.0
*
* Description:
*  This file provides constants and parameter values for the FILTER_OP0
*  component.
*
* Note:
*  None.
...
#if !defined(CY_FILTER_OP0_H)
#define CY_FILTER_OP0_H
...
/*******************************************************************************
                            Internal Constants
*******************************************************************************/
#define FILTER_OP0_CTB_HW                         CTBM0
#define FILTER_OP0_OPAMP_NUM                      ((FILTER_OP0_cy_mxs40_opamp__OA_IDX == 0u) \
...
*******************************************************************************/
#define FILTER_OP0_PARAM_Power                    (3UL)
#define FILTER_OP0_PARAM_OutputDrive              (1UL)
#define FILTER_OP0_PARAM_DeepSleep                (0UL)
...
*******************************************************************************/
    ...
    #define FILTER_OP0_OPAMP_CHARGEPUMP           CY_CTB_PUMP_DISABLE
#else
    /* Charge pump configuration depends on Deep Sleep selection in the customizer. */
    #define FILTER_OP0_OPAMP_CHARGEPUMP           CY_CTB_PUMP_ENABLE
#endif
/*******************************************************************************
                        Function Prototypes
*******************************************************************************/
void FILTER_OP0_Start(void);
__STATIC_INLINE void FILTER_OP0_Init(void);
__STATIC_INLINE void FILTER_OP0_Enable(void);
__STATIC_INLINE void FILTER_OP0_Stop(void);
__STATIC_INLINE void FILTER_OP0_SetPower(cy_en_ctb_power_t power);
__STATIC_INLINE void FILTER_OP0_SetDeepSleepMode(cy_en_ctb_deep_sleep_t deepSleep);

/*******************************************************************************
* Function Name: FILTER_OP0_Init
****************************************************************************//**
*
...
*
* It is not necessary to call FILTER_OP0_Init() because
* FILTER_OP0_Start() calls this function. FILTER_OP0_Start() is the
* preferred method to begin component operation.
*
*******************************************************************************/
__STATIC_INLINE void FILTER_OP0_Init(void)
{
    (void) Cy_CTB_OpampInit(FILTER_OP0_CTB_HW, FILTER_OP0_OPAMP_NUM, &FILTER_OP0_opampConfig);
}

/*******************************************************************************
* Function Name: FILTER_OP0_Enable
****************************************************************************//**
*
* Turn on the CTB and set the opamp power level based on last call to
* FILTER_OP0_SetPower(). If FILTER_OP0_SetPower() was never called,
...
__STATIC_INLINE void FILTER_OP0_Enable(void)
{
    Cy_CTB_Enable(FILTER_OP0_CTB_HW);
    Cy_CTB_SetPower(FILTER_OP0_CTB_HW, FILTER_OP0_OPAMP_NUM, FILTER_OP0_opampPower, FILTER_OP0_OPAMP_CHARGEPUMP);
}

/*******************************************************************************
* Function Name: FILTER_OP0_Stop
****************************************************************************//**
*
...
__STATIC_INLINE void FILTER_OP0_Stop(void)
{
    Cy_CTB_SetPower(FILTER_OP0_CTB_HW, FILTER_OP0_OPAMP_NUM, CY_CTB_POWER_OFF, FILTER_OP0_OPAMP_CHARGEPUMP);
}

/*******************************************************************************
* Function Name: FILTER_OP0_SetPower
****************************************************************************//**
*
* Set the power level for the opamp.
*
* \param power
* - CY_CTB_POWER_OFF: This input option does nothing. FILTER_OP0_Stop()
...
__STATIC_INLINE void FILTER_OP0_SetPower(cy_en_ctb_power_t power)
{
    ...
    {
        Cy_CTB_SetPower(FILTER_OP0_CTB_HW, FILTER_OP0_OPAMP_NUM, power, FILTER_OP0_OPAMP_CHARGEPUMP);

        /* Update the tracking variable for the opamp power level */
        FILTER_OP0_opampPower = power;
    }
}

/*******************************************************************************
* Function Name: FILTER_OP0_SetDeepSleepMode
****************************************************************************//**
*
...
*
* If FILTER_OP0_Stop() is called before entering Deep Sleep mode,
...
__STATIC_INLINE void FILTER_OP0_SetDeepSleepMode(cy_en_ctb_deep_sleep_t deepSleep)
{
    Cy_CTB_SetDeepSleepMode(FILTER_OP0_CTB_HW, deepSleep);
}

#endif /* !defined(CY_FILTER_OP0_H) */
