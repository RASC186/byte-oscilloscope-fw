...
/* Generated code */
const cy_stc_dma_descriptor_config_t ADC_DMA_adcDescriptor_config =
{
    ...
    .dstYincrement   = 0L,
    .yCount          = 1UL,
    .nextDescriptor  = &ADC_DMA_adcDescriptor
};

cy_stc_dma_descriptor_t ADC_DMA_adcDescriptor =
{
    .ctl = 0UL,
    .src = 0UL,
    .dst = 0UL,
...
void ADC_DMA_Start(void const * srcAddress, void const * dstAddress)
{
    ...
    Cy_DMA_Descriptor_SetSrcAddress(&ADC_DMA_adcDescriptor, srcAddress);
    Cy_DMA_Descriptor_SetDstAddress(&ADC_DMA_adcDescriptor, dstAddress);
...
void ADC_DMA_Init(void)
{
    ...
    (void)Cy_DMA_Descriptor_Init(&ADC_DMA_adcDescriptor, &ADC_DMA_adcDescriptor_config);


    channelConfig.descriptor  = &ADC_DMA_adcDescriptor;
