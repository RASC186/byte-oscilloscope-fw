...
/* ADC_CLK */
#define ADC_CLK__DIV_IDX 2
#define ADC_CLK__DIV_NUM 2
#define ADC_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* ADC_DMA */
#define ADC_DMA_DW__BLOCK_HW DW0
#define ADC_DMA_DW__BLOCK_NUMBER 0u
#define ADC_DMA_DW__CHANNEL_HW DW0_CH_STRUCT0
#define ADC_DMA_DW__CHANNEL_NUMBER 0u
#define ADC_DMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN0

/* ADC_PWM */
#define ADC_PWM_TCPWM__CNT_HW TCPWM0_CNT0
#define ADC_PWM_TCPWM__CNT_IDX 0u
#define ADC_PWM_TCPWM__HW TCPWM0
#define ADC_PWM_TCPWM__IDX 0u

/* PWM_CLK */
#define PWM_CLK__DIV_IDX 1
#define PWM_CLK__DIV_NUM 1
#define PWM_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* UART_CLK */
#define UART_CLK__DIV_IDX 0
#define UART_CLK__DIV_NUM 0
#define UART_CLK__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* FILTER_OP0 */
#define FILTER_OP0_cy_mxs40_opamp__HW CTBM0
#define FILTER_OP0_cy_mxs40_opamp__IDX 1
#define FILTER_OP0_cy_mxs40_opamp__OA_IDX 1u

/* FILTER_OP1 */
#define FILTER_OP1_cy_mxs40_opamp__HW CTBM0
#define FILTER_OP1_cy_mxs40_opamp__IDX 0
#define FILTER_OP1_cy_mxs40_opamp__OA_IDX 0u

/* OSCILLOSCOPE_ADC */
#define OSCILLOSCOPE_ADC_SAR__HW SAR
#define OSCILLOSCOPE_ADC_SAR__IDX 0
#define OSCILLOSCOPE_ADC_SAR__TR_SAR_IN TRIG6_OUT_PASS_TR_SAR_IN
#define OSCILLOSCOPE_ADC_SAR__TR_SAR_OUT TRIG14_IN_PASS_TR_SAR_OUT

/* OSCILLOSCOPE_UART */
#define OSCILLOSCOPE_UART_SCB__HW SCB5
#define OSCILLOSCOPE_UART_SCB__IDX 5
#define OSCILLOSCOPE_UART_SCB__SS0_POSITION 0u
#define OSCILLOSCOPE_UART_SCB__SS1_POSITION 1u
#define OSCILLOSCOPE_UART_SCB__SS2_POSITION 2u
#define OSCILLOSCOPE_UART_SCB__SS3_POSITION 3u
...
#define CY_PROJECT_NAME "Byte-Oscilloscope"
